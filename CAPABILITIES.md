...
> 29 functions. 🟢 live · 🟡 degraded · 🔴 broken · ⚪ planned.
...
| `search.searchNews` | Planned — declared behind this capability, not built yet. | 1 | ⚪ |
| `search.searchWeb` | Planned — declared behind this capability, not built yet. | 1 | ⚪ |
