...
> 88 functions. 🟢 live · 🟡 degraded · 🔴 broken · ⚪ planned.
...
| `gas_prices.search` | Returns cheapest gas stations near a US ZIP code, sorted by price ascending. | 1 | 🟢 |
...
| `municipal_recreation_fees.getFeeSchedule` | Returns annual recreation centre membership fees for a New Brunswick municipality | 1 | 🟢 |
